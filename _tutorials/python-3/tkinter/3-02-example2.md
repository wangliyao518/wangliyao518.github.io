...
学习资料:
  * [相关代码](https://github.com/wangliyao518/tutorials/tree/master/tkinterTUT/tk14_login_example){:target="_blank"}
...
最后在把上一节做好的界面补充就可以了。本节全套代码在leo的 [github](https://github.com/wangliyao518/tutorials/tree/master/tkinterTUT/tk14_login_example){:target="_blank"} 中可以找到.
