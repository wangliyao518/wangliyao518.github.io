...
学习资料:
  * [相关代码](https://github.com/wangliyao518/tutorials/blob/master/tkinterTUT/tk9_menubar.py){:target="_blank"}
...
do 0 ,do 1 , do 2...
再补充一下 Tkinter 的[必备步骤](https://github.com/wangliyao518/tutorials/blob/master/tkinterTUT/tk9_menubar.py){:target="_blank"},
整个框架的全部代码就完美了.